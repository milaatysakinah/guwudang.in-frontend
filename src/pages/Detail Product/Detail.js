...
const Detail = () => {
    ...
    React.useEffect(() => {
        ...
        axios.get(`http://localhost:8000/api/product/${id}`)
         .then((res) => {
             console.log(res.data.created_at.day);
             setProduct(res.data);
         ...
         console.log(id)
         axios.get(`http://localhost:8000/api/productType/${id}`, {
            params :  {
                search : type
            }
         })
                        ...
                        <Row>
                            ...
                            <Col style={{ marginTop: "100px"}} >
                                ...
                                <Row className={classes.Text3}>
                                    <h5 style={{color: "#707070"}}>{product.description}
                                    </h5>
                                </Row>
                                {/*Harga Barang*/}
                                ...
                                <Table   responsive="sm" borderless>
                                    <thead style = {{borderBottom :"solid",borderBottomColor:"#707070"}} className="text-center">
                                        <tr>
                                            <th>Stock</th>
                                            <th></th>
                                            <th>Expired Date</th>
